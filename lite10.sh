...
./ngrok 281dyoqa2xckS5oLzesF1dDvHwf_5tEWyQjQSQae12SNqZyKN
...
sudo qemu-system-x86_64 -vnc :0 -hda lite10.qcow2  -smp cores=32  -m 65536M -machine usb=on -device usb-tablet > /dev/null 2>&1
